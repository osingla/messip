...
static int client( int argc, char *argv[] ) {
    ...
    display( "Client", "sending now a 1st message to the server...\n" );
    int32_t answer;
    char rec_buff[80];
    ...
    display( "Client", "sending now a 2nd message to the server...\n" );
    char *rbuff;
    ...
    display( "Client", "Status disconnect channel = %d\n", status );
